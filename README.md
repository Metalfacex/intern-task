...
ბაგი იყო BookingService-ში. ლოგიკა ჯერ ამოწმებდა იყო თუ არა საკმარისი ბილეთები შემდეგ delay და მხოლოდ ამის შემდეგ აკლებდა ბილეთებს ბაზაში. ეს ქმნიდა პრობლემას, რადგან რამდენიმე მომხმარებელი ერთდროულად ან ძალიან მოკლე ინტერვალში რომ გააკეთებდა შეკვეთას, ორივე გადიოდა შემოწმებას მანამდე, სანამ ბილეთების რაოდენობა განახლდებოდა. შედეგად ორივე იუზერს უჩვენებდა რომ ბილეთების ყიდვა შეეძლოთ, რომ ბილეთი ჯერ კიდევ ხელმისაწვდომია და ხდებოდა overbooking. 

BookingService-ში ლოგიკა შევცვალე ისე, რომ ბილეთების რაოდენობის შემოწმება და დაკლება Java-ში ცალ-ცალკე აღარ ხდებოდეს. TicketPoolRepository-ში დავამატე კასტომ მეთოდი tryDecrementTickets, რომელიც ერთ UPDATE query-ით აკლებს availableTickets-ს მხოლოდ იმ შემთხვევაში, თუ availableTickets >= qty პირობა სრულდება. bookTickets()-ში ჯერ ამ მეთოდს ვიძახებ და თუ დაბრუნებული მნიშვნელობა 0-ია, ვაბრუნებ შეცდომას (ან ევენთი არ არსებობს, ან ბილეთები არ არის საკმარისი), ხოლო თუ დაბრუნდა 1, მაშინ ვტვირთავ TicketPool-ს, ვქმნი Booking ობიექტს და ვინახავ ბაზაში.
